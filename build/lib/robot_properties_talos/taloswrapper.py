...
Anymal pybullet interface using pinocchio's convention.
...
class TalosRobot(PinBulletWrapper):
    def __init__(
        self,
        pos=None,
        orn=None,
        ...
        * [
        ...
        pybullet.setAdditionalSearchPath(TalosConfig.meshes_path)
        self.urdf_path = TalosConfig.urdf_path
        ...
        self.pin_robot = TalosConfig.buildRobotWrapper()
        ...
        #     self.end_effector_names.append(ee + "_ADAPTER_TO_FOOT")
        for names in self.pin_robot.model.names[2:]:
            controlled_joints.append(names)
        ...
        # 
        super(TalosRobot, self).__init__(
            self.robotId,
            self.pin_robot,
            controlled_joints,
            self.end_effector_names,
